...
The executable ("dorbs") is all you need, use it (you really shouldn't) by writing ./dorbs, or ./dorbs [port number] – the port number defaults to 9001. It is compiled for Linux on X86.
